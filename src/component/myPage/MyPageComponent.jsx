            ...
            <div className="pb-40 text-bara_sodomy mt-[9rem] bg-bara_gray_1">
                ...
                <div className="bg-white py-4 px-8 mb-4">
                    <div className="bg-bara_gray_1 rounded-[0.5rem] w-full h-28 flex justify-between items-center p-8 relative">
                        ...
                        <div className="absolute left-1/3 top-1/2 transform -translate-x-1/2 -translate-y-1/2 h-12 w-[1px] bg-bara_gray_3"></div>
                        ...
                        <div className="absolute left-2/3 top-1/2 transform -translate-x-1/2 -translate-y-1/2 h-12 w-[1px] bg-bara_gray_3"></div>
                                ...
                                {freqProduct.map((product) => (
                                    ...
                                    >
                                        <div className="w-40 flex-shrink-0 flex flex-col">
                                            ...
                                            <div className="mt-2">
                                                <h4>{product.pname}</h4>
                                                <p className="text-bara_blue text-[1.2rem] font-bold">
